...
function validateStoreTel(event) {
	var inputElement = document.getElementById("storeTel");
	var inputValue = inputElement.value;
	console.log(inputValue);
...
document.getElementById("storeTel").addEventListener("blur", validateStoreTel);
