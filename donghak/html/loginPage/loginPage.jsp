...
<body>
        ...
        <div class="loginPageContainer">
            ...
            <div class="loginFormWrapper">
                <form class="loginForm" action="loginClick.do" method="POST">
                    <div class="formInput">
                        <input id="userId" type ="text" name ="userId" autocomplete="off" required placeholder="아이디">
                    </div >
                    <div class="formInput">
                        <input id="userPass" type="password" name="userPass" autocomplete="off" required placeholder="비밀번호">
                    </div>
    ...
    <script src="../../resources/static/js/loginCheck.js"></script>
